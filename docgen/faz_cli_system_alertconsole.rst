...
.. raw:: html
 ...
 <li><span class="li-head">severity_level</span> Alert console keeps alerts of this and higher severity. <span class="li-normal">type: list</span> <span class="li-normal">elements: str</span> <span class="li-normal">choices: [debug, information, notify, warning, error, critical, alert, emergency]</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
