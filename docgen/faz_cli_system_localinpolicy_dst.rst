:source: faz_cli_system_localinpolicy_dst.py

:orphan:

.. _faz_cli_system_localinpolicy_dst:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_localinpolicy_dst</span> Cli system local in policy dst <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">dst_ip</span> <span class="li-normal">type: str</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Cli system local in policy dst
        fortinet.fortianalyzer.faz_cli_system_localinpolicy_dst:
          # bypass_validation: false
          # rc_succeeded: [0, -2, -3, ...]
          # rc_failed: [-2, -3, ...]
          local_in_policy: <your own value>
          state: present # <value in [present, absent]>
          cli_system_localinpolicy_dst:
            # dst_ip: <value of string>
