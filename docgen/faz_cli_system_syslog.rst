...
.. raw:: html
 ...
 <li><span class="li-head">peer_cert_cn</span> - Certificate common name of syslog server. <span class="li-normal">type: str</span>  <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
