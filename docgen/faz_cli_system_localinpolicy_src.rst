:source: faz_cli_system_localinpolicy_src.py

:orphan:

.. _faz_cli_system_localinpolicy_src:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_localinpolicy_src</span> Cli system local in policy src <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Cli system local in policy src
        fortinet.fortianalyzer.faz_cli_system_localinpolicy_src:
          # bypass_validation: false
          # rc_succeeded: [0, -2, -3, ...]
          # rc_failed: [-2, -3, ...]
          local_in_policy: <your own value>
          state: present # <value in [present, absent]>
          cli_system_localinpolicy_src:
