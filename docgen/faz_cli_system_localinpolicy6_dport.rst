:source: faz_cli_system_localinpolicy6_dport.py

:orphan:

.. _faz_cli_system_localinpolicy6_dport:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_localinpolicy6_dport</span> Cli system local in policy6 dport <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Cli system local in policy6 dport
        fortinet.fortianalyzer.faz_cli_system_localinpolicy6_dport:
          # bypass_validation: false
          # rc_succeeded: [0, -2, -3, ...]
          # rc_failed: [-2, -3, ...]
          local_in_policy6: <your own value>
          state: present # <value in [present, absent]>
          cli_system_localinpolicy6_dport:
