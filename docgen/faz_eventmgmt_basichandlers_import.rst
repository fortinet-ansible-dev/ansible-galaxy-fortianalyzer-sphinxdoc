:source: faz_eventmgmt_basichandlers_import.py

:orphan:

.. _faz_eventmgmt_basichandlers_import:
...
.. raw:: html
 ...
 <li><span class="li-head">eventmgmt_basichandlers_import</span> Import basic handlers. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">attachment</span> Objects that will be imported with basic handlers. <span class="li-normal">type: list</span> <span class="li-normal">elements: str</span> <span class="li-normal">choices: [notification-profile]</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
