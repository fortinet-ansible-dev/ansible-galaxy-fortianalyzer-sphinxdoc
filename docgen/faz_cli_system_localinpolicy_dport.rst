:source: faz_cli_system_localinpolicy_dport.py

:orphan:

.. _faz_cli_system_localinpolicy_dport:
...
.. raw:: html
 ...
 <li><span class="li-head">local-in-policy</span> The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">cli_system_localinpolicy_dport</span> Cli system local in policy dport <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">dport_value</span> <span class="li-normal">type: str</span>  <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Cli system local in policy dport
        fortinet.fortianalyzer.faz_cli_system_localinpolicy_dport:
          # bypass_validation: false
          # rc_succeeded: [0, -2, -3, ...]
          # rc_failed: [-2, -3, ...]
          local_in_policy: <your own value>
          state: present # <value in [present, absent]>
          cli_system_localinpolicy_dport:
            # dport_value: <value of string>
