...
.. raw:: html
 ...
 <li><span class="li-head">no-log-detection-threshold</span> - Time interval in minutes to trigger a local event message if no log data is received. <span class="li-normal">type: int</span>  <span class="li-normal">default: 15</span>  <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
