...
.. raw:: html
 ...
 <li><span class="li-head">ip6_allowaccess</span> Allow management access to interface. <span class="li-normal">type: list</span> <span class="li-normal">elements: str</span> <span class="li-normal">choices: [ping, https, ssh, snmp, http, webservice, fgfm, https-logging, fabric]</span>  <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
