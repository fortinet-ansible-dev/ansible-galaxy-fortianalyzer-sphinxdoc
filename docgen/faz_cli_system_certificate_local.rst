...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">certificate</span> Certificate. <span class="li-normal">type: str</span> <span class="li-normal">elements: str</span> <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 ...
 <li><span class="li-head">csr</span> Certificate Signing Request. <span class="li-normal">type: str</span> <span class="li-normal">elements: str</span> <a id='label4' href="javascript:ContentClick('label5', 'label4');" onmouseover="ContentPreview('label5');" onmouseout="ContentUnpreview('label5');" title="click to collapse or expand..."> more... </a>
 ...
 <li><span class="li-head">password</span> Local certificate password. <span class="li-normal">type: str</span> <span class="li-normal">elements: str</span> <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
 <div id="label9" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.2.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">private_key</span> Local certificate private-key. <span class="li-normal">type: str</span> <span class="li-normal">elements: str</span> <a id='label10' href="javascript:ContentClick('label11', 'label10');" onmouseover="ContentPreview('label11');" onmouseout="ContentUnpreview('label11');" title="click to collapse or expand..."> more... </a>
