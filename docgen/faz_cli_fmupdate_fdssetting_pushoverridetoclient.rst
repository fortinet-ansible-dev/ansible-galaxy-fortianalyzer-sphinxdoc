...
.. raw:: html
 ...
 <li><span class="li-head">cli_fmupdate_fdssetting_pushoverridetoclient</span> - Enable/disable push updates, and override the default IP address and port used by FortiGuard to send antivirus and IPS push messages for... <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
