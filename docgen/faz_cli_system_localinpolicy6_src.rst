:source: faz_cli_system_localinpolicy6_src.py

:orphan:

.. _faz_cli_system_localinpolicy6_src:
...
.. raw:: html
 ...
 <li><span class="li-head">cli_system_localinpolicy6_src</span> Cli system local in policy6 src <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook
    ...
    tasks:
      - name: Cli system local in policy6 src
        fortinet.fortianalyzer.faz_cli_system_localinpolicy6_src:
          # bypass_validation: false
          # rc_succeeded: [0, -2, -3, ...]
          # rc_failed: [-2, -3, ...]
          local_in_policy6: <your own value>
          state: present # <value in [present, absent]>
          cli_system_localinpolicy6_src:
