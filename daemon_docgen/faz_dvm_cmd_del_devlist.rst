...
.. raw:: html
 ...
 <li><span class="li-head">del_dev_member_list</span> <span class="li-normal">type: list of dict</span>
 ...
 <li><span class="li-head">flags</span> create_task - Create a new task in task manager database. <span class="li-normal">type: list</span> <span class="li-normal">elements: str</span> <span class="li-normal">choices: [none, create_task, nonblocking]</span>  <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
